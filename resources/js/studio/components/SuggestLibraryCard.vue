...
<template>
  <div class="flex flex-col h-full">
      ...
      <div class="flex items-center gap-2">
        <div class="relative flex-1">
          <input
            ...
            class="w-full rounded-lg border border-ink-600 bg-ink-800 px-3 py-1.5 pl-8 text-xs text-cream-100 placeholder:text-cream-400 focus:border-brand-500 focus:outline-none"
          />
          <StudioIcon name="search" size="h-3.5 w-3.5" class="absolute left-2.5 top-1/2 -translate-y-1/2 text-cream-400" />
        </div>
        <button
    ...
    <div class="flex-1 overflow-y-auto scrollbar-hide p-3">
      <div v-if="store.suggestLibLoading && !store.suggestLibItems.length" class="py-16 text-center text-xs text-cream-400">
        ...
        >
          ...
          <div class="aspect-square overflow-hidden bg-ink-900">
            <img
              ...
              loading="lazy"
            />
            <div v-else class="flex h-full w-full items-center justify-center text-cream-400">
