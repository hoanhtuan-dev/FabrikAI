      ...
      <div class="w-full max-w-2xl max-h-[88vh] overflow-y-auto rounded-lg border border-brand-500/40 bg-ink-900 shadow-2xl" @click.stop>
        ...
        <div class="space-y-3 p-4 text-xs">
          ...
          <div>
            ...
            <input v-model="form.reference_url" type="text" placeholder="/storage/api/ref/…" class="w-full rounded-lg border border-ink-600 bg-ink-800 px-3 py-2 text-cream-100 placeholder:text-cream-300/30 focus:border-brand-400 focus:outline-none" />
          </div>
