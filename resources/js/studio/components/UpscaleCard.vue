...
<template>
  <div class="card p-5">
    ...
    <div v-else class="mt-3 text-xs text-cream-400">Chọn ảnh để nâng cấp.</div>
    ...
    <!-- Tinh chỉnh AI -->
    <div class="mt-2 flex items-center gap-3 rounded-lg border border-ink-700 bg-cream-50/5 px-3 py-2.5 text-xs">
    ...
    <p v-if="!store.upscaling && !store.upscaleSrc" class="mt-1.5 text-label leading-4 text-warn">↳ Chưa có ảnh để nâng cấp — bấm vào một ảnh trên canvas hoặc trong Kết quả.</p>
