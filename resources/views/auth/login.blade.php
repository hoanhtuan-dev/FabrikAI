...
<div class="container-x flex min-h-[85vh] items-center justify-center py-16">
    <div class="w-full max-w-md rounded-2xl border border-ink-700 bg-ink-900 p-8 shadow-2xl">
        ...
        <p class="mt-1 text-sm text-cream-300/60">Studio thiết kế thời trang AI.</p>
        ...
        <p class="mt-4 text-sm text-cream-300/60">Chưa có tài khoản? <a href="{{ route('register') }}" class="link">Đăng ký</a></p>
        <p class="mt-2 text-xs text-cream-300/60">Muốn xem gói và giá trước? <a href="{{ route('pricing.page') }}" class="link">Bảng giá</a></p>
    </div>
</div>
@endsection
